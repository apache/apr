...
static void hash_traverse(CuTest *tc)
{
    ...
    CuAssertStrEquals(tc, "Key FOO2 (4) Value bar2\n", StrArray[1]);
    CuAssertStrEquals(tc, "Key FOO3 (4) Value bar3\n", StrArray[2]);
    CuAssertStrEquals(tc, "Key FOO4 (4) Value bar4\n", StrArray[3]);
    CuAssertStrEquals(tc, "Key OVERWRITE (9) Value Overwrite key\n",
                          StrArray[4]);
    CuAssertStrEquals(tc, "Key SAME1 (5) Value same\n", StrArray[5]);
    CuAssertStrEquals(tc, "Key SAME2 (5) Value same\n", StrArray[6]);
    CuAssertStrEquals(tc, "#entries 7\n", StrArray[7]);
}
...
static void overlay_empty(CuTest *tc)
{
    ...
    CuAssertStrEquals(tc, "Key key2 (4) Value value2\n", StrArray[1]);
    CuAssertStrEquals(tc, "Key key3 (4) Value value3\n", StrArray[2]);
    CuAssertStrEquals(tc, "Key key4 (4) Value value4\n", StrArray[3]);
    CuAssertStrEquals(tc, "Key key5 (4) Value value5\n", StrArray[4]);
    CuAssertStrEquals(tc, "#entries 5\n", StrArray[5]);
}
...
static void overlay_2unique(CuTest *tc)
{
    ...
    CuAssertStrEquals(tc, "Key base1 (5) Value value1\n", StrArray[0]);
    CuAssertStrEquals(tc, "Key base2 (5) Value value2\n", StrArray[1]);
    CuAssertStrEquals(tc, "Key base3 (5) Value value3\n", StrArray[2]);
    CuAssertStrEquals(tc, "Key base4 (5) Value value4\n", StrArray[3]);
    CuAssertStrEquals(tc, "Key base5 (5) Value value5\n", StrArray[4]);
    CuAssertStrEquals(tc, "Key overlay1 (8) Value value1\n", StrArray[5]);
    CuAssertStrEquals(tc, "Key overlay2 (8) Value value2\n", StrArray[6]);
    CuAssertStrEquals(tc, "Key overlay3 (8) Value value3\n", StrArray[7]);
    CuAssertStrEquals(tc, "Key overlay4 (8) Value value4\n", StrArray[8]);
    CuAssertStrEquals(tc, "Key overlay5 (8) Value value5\n", StrArray[9]);
    CuAssertStrEquals(tc, "#entries 10\n", StrArray[10]);
}
...
static void overlay_fetch(CuTest *tc)
{
    apr_hash_t *base = NULL;
    apr_hash_t *overlay = NULL;
    apr_hash_t *result = NULL;
...
CuSuite *testhash(void)
{
    ...
    SUITE_ADD_TEST(suite, overlay_fetch);
